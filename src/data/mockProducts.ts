...
export const CATEGORIES_DATA: CategoryInfo[] = [
  ...
  },
  {
    ...
    nameHi: 'खाद एवं पोषक तत्व',
    nameMr: 'खते व पोषकतत्वे',
    emoji: '🧪',
    iconName: 'Flask',
  ...
  {
    id: 'animal_feed',
    nameEn: 'Animal Feed & Silage',
    nameHi: 'पशुआहार व साइलेज',
  ...
  {
    id: 'nursery_plants',
    nameEn: 'Polyhouse Nursery',
    nameHi: 'पॉलीहाउस नर्सरी',
    nameMr: 'नर्सरी व रोपे',
    emoji: '🪴',
    iconName: 'Plant',
    ...
    bgColor: '#DCFCE7',
    count: 12,
    descriptionEn: 'Polyhouse greenhouse plants, decorative saplings and grafting roots',
    descriptionHi: 'पॉलीहाउस ग्रीनहाउस के पौधे, सजावटी पौधे व ग्राफ्टेड कलमें',
    descriptionMr: 'पॉलीहाऊसमधील संरक्षित रोपे, सुशोभित झाडे व उत्तम कलमे'
  },
  {
    id: 'fruit_plants',
    nameEn: 'Fruit Orchards',
    nameHi: 'फलों के पौधे व बागवानी',
    nameMr: 'फळझाडे व बागकाम',
    emoji: '🥭',
    iconName: 'Apple',
    ...
    bgColor: '#FEF3C7',
    count: 14,
    descriptionEn: 'Kesar mango, Taiwan pink guava, pomegranate, citrus & dragon fruit saplings',
    descriptionHi: 'केसर आम, ताइवान पिंक अमरूद, अनार, संतरा व ड्रैगन फ्रूट के कलमी पौधे',
    descriptionMr: 'केशर आंबा, तैवान पेरू, डाळिंब, संत्री व ड्रॅगन फ्रूटची खात्रीशीर रोपे'
  },
  {
    id: 'irrigation',
    nameEn: 'Drip & Sprinklers',
    nameHi: 'ड्रिप व स्प्रिंकलर सिंचाई',
    nameMr: 'ठिबक व तुषार सिंचन',
    emoji: '💧',
    iconName: 'Droplet',
    ...
    bgColor: '#E0F2FE',
    count: 15,
    descriptionEn: 'Inline drip tubes, venturi injectors, rain guns, sprinkler nozzles & HDPE pipes',
    descriptionHi: 'इनलाइन ड्रिप नली, वेंचुरी, रेन गन, स्प्रिंकलर नोजल व एचडीपीई पाइप',
    descriptionMr: 'इनलाइन ठिबक नळ्या, व्हेंचुरी, रेन गन, तुषार सिंचन नोजल्स व पाइप्स'
  },
  {
    id: 'solar_agriculture',
    nameEn: 'Solar Agri Pumps',
    nameHi: 'सोलर पंप व ऊर्जा',
    nameMr: 'सौर कृषी पंप',
    emoji: '☀️',
    iconName: 'Sun',
    image: 'https://images.unsplash.com/photo-1509391365360-2e959784a276?w=500&auto=format&fit=crop&q=80',
    ...
    bgColor: '#FEF9C3',
    count: 8,
    descriptionEn: '3HP to 7.5HP solar water pump sets, DC submersible motors & solar fence systems',
    descriptionHi: '3एचपी से 7.5एचपी सोलर वाटर पंप सेट, डीसी सबमर्सिबल व सोलर झटका मशीन',
    descriptionMr: '३ ते ७.५ एचपी सौर कृषी पंप संच, डीसी मोटर्स व सोलर कुंपण यंत्र'
  },
  {
    id: 'dairy_cattle',
    nameEn: 'Dairy Cattle & Buffalo',
    nameHi: 'गाय व भैंस (दुधारू)',
    nameMr: 'दुभत्या गायी व म्हशी',
    emoji: '🥛',
    iconName: 'Milk',
    image: 'https://images.unsplash.com/photo-1546445317-29f4545e9d53?w=500&auto=format&fit=crop&q=80',
    color: '#475569',
    bgColor: '#F1F5F9',
    count: 12,
    descriptionEn: 'High milk yielding Gir, HF, Jersey cows & Murrah, Jafrabadi buffaloes',
    descriptionHi: 'उच्च दुग्ध उत्पादन वाली गिर, एचएफ, जर्सी गायें व मुर्रा, जाफराबादी भैंसें',
    descriptionMr: 'अधिक दूध देणाऱ्या गीर, एचएफ, जर्सी गायी व मुऱ्हा, जाफराबादी म्हशी'
  },
  {
    id: 'goat_sheep',
    nameEn: 'Goat & Sheep Farming',
    nameHi: 'बकरी व भेड़ पालन',
    nameMr: 'शेळी व मेंढी पालन',
    emoji: '🐐',
    iconName: 'Heart',
    image: 'https://images.unsplash.com/photo-1535268647677-300dbf3d78d1?w=500&auto=format&fit=crop&q=80',
    color: '#854D0E',
    bgColor: '#FEF3C7',
    count: 9,
    descriptionEn: 'Boer, Sirohi, Osmanabadi, Barbari goats & pure breed sheep for commercial farming',
    descriptionHi: 'बोर, सिरोही, उस्मानाबादी, बरबरी बकरियां व उन्नत नस्ल की भेड़ें',
    descriptionMr: 'बोअर, सिरोही, उस्मानाबादी शेळ्या व जातिवंत मेंढ्या'
  },
  {
    id: 'poultry_farming',
    nameEn: 'Poultry & Desi Chicks',
    nameHi: 'मुर्गी पालन व चूजे',
    nameMr: 'कुक्कुटपालन व पिल्ले',
    emoji: '🐔',
    iconName: 'Egg',
    ...
    bgColor: '#FEE2E2',
    count: 11,
    descriptionEn: 'Day-old Kadaknath, Sonali, RIR, DP Cross chicks & modern poultry feeders',
    descriptionHi: 'कड़कनाथ, सोनाली, आरआईआर देसी चूजे व पोल्ट्री दाना फीडर',
    descriptionMr: 'कडकनाथ, सोनाली, आरआयआर देशी पिल्ले व पोल्ट्री साहित्य'
  },
  {
    id: 'organic_compost',
    nameEn: 'Organic Vermicompost',
    nameHi: 'जैविक केंचुआ व गोबर खाद',
    ...
    bgColor: '#DCFCE7',
    count: 13,
    descriptionEn: '100% pure Australian Eisenia fetida vermicompost & well-rotted cow dung manure',
    descriptionHi: '100% शुद्ध केंचुआ खाद (वर्मीकंपोस्ट) व पुरानी सड़ी गोबर खाद',
    descriptionMr: '१००% शुद्ध गांडूळ खत व जुने कुजलेले शेणखत'
  },
  {
    id: 'spices_garlic',
    nameEn: 'Garlic & Ginger Spices',
    nameHi: 'लहसुन, अदरक व मसाले',
    nameMr: 'लसूण, आले व मसाले',
    emoji: '🧄',
    iconName: 'Flame',
    image: 'https://images.unsplash.com/photo-1618512496248-a07fe83aa8cb?w=500&auto=format&fit=crop&q=80',
    color: '#78350F',
    bgColor: '#FEF3C7',
    count: 14,
    descriptionEn: 'Ooty garlic seed, Mahim ginger rhizomes, turmeric fingers & whole spices',
    descriptionHi: 'ऊटी लहसुन बीज, माहिम अदरक गांठ, साबुत हल्दी व मसाले',
    descriptionMr: 'उटी लसूण बेणे, माहिम आले बेणे, हळद व दर्जेदार मसाले'
  },
  {
    id: 'paddy_rice',
    nameEn: 'Paddy & Basmati Rice',
    nameHi: 'धान एवं बासमती चावल',
    nameMr: 'भात व बासमती तांदूळ',
    emoji: '🍚',
    iconName: 'Feather',
    ...
    bgColor: '#FEF9C3',
    count: 10,
    descriptionEn: 'PB 1121, 1509, 1718 Basmati paddy stock, Govind Bhog & Kolam raw rice',
    descriptionHi: 'पूसा बासमती 1121, 1509, 1718 धान का थोक माल व गोविंद भोग चावल',
    descriptionMr: 'पुसा बासमती ११२१, १५०९ भात शेतमाल व कोलम तांदूळ'
  },
  {
    id: 'cotton_kapas',
    nameEn: 'Cotton & Fiber Crops',
    nameHi: 'कपास व रेशा फसल',
    nameMr: 'कापूस शेतमाल',
    emoji: '☁️',
    iconName: 'Cloud',
    ...
    bgColor: '#E0F2FE',
    count: 8,
    descriptionEn: 'Raw white gold seed cotton (kapas), ginned cotton bales & jute fiber',
    descriptionHi: 'सफेद सोना कच्चा कपास (नरमा), जिनिंग गांठें व पटसन रेशा',
    descriptionMr: 'शुभ्र पांढरा कापूस, रुई गाठी व ताग रेशा शेतमाल'
  },
  {
    id: 'sugarcane_sets',
    nameEn: 'Sugarcane Sets & Buds',
    nameHi: 'गन्ना बीज व बेणे',
    nameMr: 'ऊस बेणे व वाण',
    emoji: '🎋',
    iconName: 'Activity',
    image: 'https://images.unsplash.com/photo-1592417817098-8f3d6eb22509?w=500&auto=format&fit=crop&q=80',
    color: '#16A34A',
    bgColor: '#DCFCE7',
    count: 7,
    descriptionEn: 'Co 0238, Co 86032, CoM 0265 single bud nursery sets and seed cane',
    descriptionHi: 'सीओ 0238, सीओ 86032 सिंगल बड गन्ना पौध व बीज बेणे',
    descriptionMr: 'को ८६०३२, को ०२६५ सिंगल बड ऊस रोपे व खात्रीशीर बेणे'
  },
  {
    id: 'pulses_dal',
    nameEn: 'Pulses, Chana & Tur',
    nameHi: 'दलहन, चना व तुवर',
    nameMr: 'कडधान्ये, हरभरा व तूर',
    emoji: '🥣',
    iconName: 'Disc',
    ...
    bgColor: '#FFEDD5',
    count: 12,
    descriptionEn: 'Kabuli chana, Desi gram, Pigeon pea (Tur), Moong & Urad harvest lots',
    descriptionHi: 'काबुली चना, देसी चना, अरहर/तुवर दाल, मूंग व उड़द की फसल',
    descriptionMr: 'काबुली चणा, गावरान हरभरा, तुरीची डाळ, मूग व उडीद'
  },
  {
    id: 'oilseeds',
    nameEn: 'Oilseeds & Groundnut',
    nameHi: 'तिलहन, सरसों व मूंगफली',
    nameMr: 'गळित धान्य, मोहरी व भुईमूग',
    emoji: '🥜',
    iconName: 'Sun',
    image: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=500&auto=format&fit=crop&q=80',
    color: '#D97706',
    bgColor: '#FEF3C7',
    count: 9,
    descriptionEn: 'Yellow mustard, bold groundnut pods, sunflower seeds & sesame (til)',
    descriptionHi: 'पीली सरसों, मूंगफली, सूरजमुखी व सफेद तिल का प्रमाणित माल',
    descriptionMr: 'पिवळी मोहरी, भुईमूग शेंगा, सूर्यफूल व तीळ शेतमाल'
  },
  {
    id: 'honey_beekeeping',
    nameEn: 'Honey & Apiculture',
    nameHi: 'शुद्ध शहद व मधुमक्खी',
    nameMr: 'शुद्ध मध व मधमाशी पालन',
    emoji: '🍯',
    iconName: 'Hexagon',
    ...
    bgColor: '#FEF9C3',
    count: 6,
    descriptionEn: 'Raw unfiltered mustard honey, multi-flora forest honey & wooden bee boxes',
    descriptionHi: 'कच्चा प्राकृतिक शहद, सरसों का शहद व मधुमक्खी पालन बॉक्स',
    descriptionMr: 'अस्सल नैसर्गिक मध, मोहरीचा मध व मधमाशी पालन पेट्या'
  },
  {
    id: 'mushroom_spawn',
    nameEn: 'Mushroom Spawn & Kits',
    nameHi: 'मशरूम स्पॉन व किट',
    nameMr: 'मशरूम उत्पादन व स्पॉन',
    emoji: '🍄',
    iconName: 'Compass',
    ...
    bgColor: '#F3E8FF',
    count: 7,
    descriptionEn: 'Oyster, Milky & Button mushroom master spawn bottles and ready grow bags',
    descriptionHi: 'ऑयस्टर, मिल्की व बटन मशरूम स्पॉन बोतलें और रेडी ग्रो बैग',
    descriptionMr: 'ऑयस्टर, मिल्की व बटन मशरूम स्पॉन आणि ग्रो किट्स'
  },
  {
    id: 'fish_aquaculture',
    nameEn: 'Fish Farming & Seed',
    nameHi: 'मत्स्य पालन व जीरा',
    nameMr: 'मत्स्य शेती व बियाणे',
    emoji: '🐟',
    iconName: 'Anchor',
    image: 'https://images.unsplash.com/photo-1534043464124-3be32fe00099?w=500&auto=format&fit=crop&q=80',
    color: '#0284C7',
    bgColor: '#E0F2FE',
    count: 6,
    descriptionEn: 'Rohu, Catla, Grass Carp, Tilapia fingerlings & floating fish feed pellets',
    descriptionHi: 'रोहू, कतला, ग्रास कार्प, तिलापिया मछली का जीरा व फ्लोटिंग फीड',
    descriptionMr: 'रोहू, कटला, ग्रास कार्प, तिलापिया मत्स्य बियाणे व फ्लोटिंग खाद्य'
  },
  {
    id: 'farm_tools',
    nameEn: 'Hand Tools & Sprayers',
    nameHi: 'हथियार व स्प्रे पंप',
    nameMr: 'हात अवजारे व स्प्रे पंप',
    emoji: '🛠️',
    iconName: 'Tool',
    image: 'https://images.unsplash.com/photo-1592878904946-b3cd8ae243d0?w=500&auto=format&fit=crop&q=80',
    color: '#4B5563',
    bgColor: '#F3F4F6',
    count: 15,
    descriptionEn: 'Battery knapsack sprayers, grafting pruners, sickles, tarpaulins & weeding hoes',
    descriptionHi: 'बैटरी नैपसैक स्प्रे पंप, प्रूनर कटर, दरांती, तिरपाल व वीडर खुरपी',
    descriptionMr: 'बॅटरी स्प्रे पंप, कलमी कटर, विळा, ताडपत्री व कोळपणी अवजारे'
  }
];
